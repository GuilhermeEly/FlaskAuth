...
class prodData(connectionAlchemy):
    ...
    def queryFpyByDate(self, startDate, endDate):
        ...
        sql = """ SELECT z2.Z2_PRODUTO as PA, z8.ZZ8_NUMEQ as NS, z8.ZZ8_PNAME as NOME,
                ...
                z8.ZZ8_OPNUM as OP, TRY_CONVERT(date,(z8.ZZ8_DATE)) as DATA, z8.ZZ8_HOUR as HORA
                FROM SZ2990 AS z2 
                INNER JOIN ZZ8990 AS z8 ON z2.Z2_SERIE=z8.ZZ8_NUMEQ
                WHERE z8.ZZ8_DATE BETWEEN %(start_date)s AND %(end_date)s ORDER BY DATA"""
    ...
    def queryFpyByDateAndPA(self, startDate, endDate, PASelected):
        ...
        sql = """
                ...
                FROM SZ2990 AS z2 
                INNER JOIN ZZ8990 AS z8 ON z2.Z2_SERIE=z8.ZZ8_NUMEQ
                WHERE z2.Z2_PRODUTO = %(PA)s AND z8.ZZ8_DATE BETWEEN %(start_date)s AND %(end_date)s ORDER BY DATA
            """
    ...
    def queryDailyFpyByPA(self, startDate, endDate, PASelected):
        ...
        sql = """
                ...
                FROM SZ2990 AS z2 
                INNER JOIN ZZ8990 AS z8 ON z2.Z2_SERIE=z8.ZZ8_NUMEQ
                WHERE z2.Z2_PRODUTO=%(PA)s AND z8.ZZ8_DATE BETWEEN %(start_date)s AND %(end_date)s ORDER BY NS, DATA, HORA
            """
